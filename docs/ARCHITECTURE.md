...
1. **Item Scattering:** Shockwave push all items from impact tiles by one tile-distance.
...
**`WeatherZone` — passive climate effects:**
...
**`WeatherEffect` — threshold-triggered effects:**
